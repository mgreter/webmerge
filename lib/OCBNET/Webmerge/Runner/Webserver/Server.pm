...
BEGIN { $OCBNET::Webmerge::Runner::Webserver::Server::VERSION = "0.9.0" }
...
sub new
{
	...
	my $listener = OCBNET::Webmerge::Runner::Webserver::Listener->new($self, $config);
