...
"%WIX%\bin\heat.exe" dir ".\gm" -nologo -cg gm -nologo -gg -scom -sreg -ke -dr APPLICATIONFOLDER -template fragment -out wix\gm.wxs -platform x86
"%WIX%\bin\heat.exe" dir ".\perl" -nologo -cg perl -nologo -gg -scom -sreg -ke -dr APPLICATIONFOLDER -template fragment -out wix\perl.wxs -platform x86
"%WIX%\bin\heat.exe" dir ".\ruby" -nologo -cg ruby -nologo -gg -scom -sreg -ke -dr APPLICATIONFOLDER -template fragment -out wix\ruby.wxs -platform x86
"%WIX%\bin\heat.exe" dir ".\jre7" -nologo -cg jre7 -nologo -gg -scom -sreg -ke -dr APPLICATIONFOLDER -template fragment -out wix\jre7.wxs -platform x86
"%WIX%\bin\heat.exe" dir ".\utils" -nologo -cg utils -nologo -gg -scom -sreg -ke -dr APPLICATIONFOLDER -template fragment -out wix\utils.wxs -platform x86
