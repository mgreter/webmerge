...
sub mergeEntry
{
	...
	foreach my $output (@{$merge->{'output'} || []})
	{
		...
		my $joined = "/* autogenerated by webmerge (join context) */\n";
		...
		if ($output->{'target'} eq 'dev')
		{

			printf "creating %s dev <%s>\n", $type, $output->{'path'};

			# create a header for this output file
			my $code = "/* autogenerated by webmerge (dev context) */\n";
		...
		elsif ($output->{'target'} eq 'minify')
		{
			...
			# create a header for this output file
			my $code = "/* autogenerated by webmerge (minify context) */\n";
		...
		elsif ($output->{'target'} eq 'compile')
		{
			...
			# create a header for this output file
			my $code = "/* autogenerated by webmerge (compile context) */\n";
		...
		# create minified output for live
		elsif ($output->{'target'} eq 'license')
		{
