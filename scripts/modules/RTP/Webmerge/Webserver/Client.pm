...
my $fh = RTP::Webmerge::Webserver::File->new($client, $server, $self);
	...
	unless ($self->antique_client) {
	    ...
	    $self->print("Access-Control-Allow-Origin: *$CRLF");
	    $self->print("Access-Control-Allow-Headers: *$CRLF");
	    $self->print("Access-Control-Allow-Methods: *$CRLF");
	    $self->print("Access-Control-Max-Age: 1000$CRLF");
